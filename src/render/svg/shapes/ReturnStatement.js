    ...
    print() {
        ...
        const arrow = getClosedPath(
            addOffsetToPoints([
                ...
                {x: 0, y: arrowSize.y}
            ], {x: x + w + arrowTheme.handlerLength, y: y + h/2 - arrowSize.y/2}),
            arrowTheme
        );
        ...
        return `
            <g>
                ...
                ${getLine(x + w, y + h/2 - arrowTheme.handlerLength,
                    x + w + arrowTheme.handlerLength, y + h/2 - arrowTheme.handlerLength, arrowTheme)}
...
const calculateWidth = (state) => {
    ...
    return 2 * (theme.horizontalPadding) + arrowTheme.handlerLength + arrowTheme.sizeX
